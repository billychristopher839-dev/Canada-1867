...
- 🎵 **Dominion Jukebox** — an iTunes-style player (LCD display, play/pause, previous/next, seek bar, volume, track list). The 11 tracks play in the listed order and, when the last one ends, repeat the same order from the top. Click any song in the list to jump straight to it; playback continues in order from there. Open it with the **Jukebox** button in the header.
